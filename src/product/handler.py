...
def get_db_connection():
    """
    Creates a database connection using the RDS credentials stored
...
def handler(event, context):
    ...
    #
    # Function URL itself uses AuthType NONE.
    # The request is authenticated here using the Bearer token
